...
typedef enum ompi_spc_counters {
    ...
    OMPI_SPC_ALLREDUCE,
    OMPI_SPC_BASIC_ALLREDUCE_INTRA,
    OMPI_SPC_BASIC_ALLREDUCE_INTER,
    OMPI_SPC_BASE_ALLREDUCE_INTRA_NONOVERLAPPING,
    OMPI_SPC_BASE_ALLREDUCE_INTRA_RECURSIVEDOUBLING,
    OMPI_SPC_BASE_ALLREDUCE_INTRA_RING,
    OMPI_SPC_BASE_ALLREDUCE_INTRA_RING_SEGMENTED,
    OMPI_SPC_BASE_ALLREDUCE_INTRA_BASIC_LINEAR,
    OMPI_SPC_BASE_ALLREDUCE_INTRA_REDSCAT_ALLGATHER,
    OMPI_SPC_SEND_TIME,
    OMPI_SPC_SENDRECV_TIME,
    OMPI_SPC_RECV_TIME,
    OMPI_SPC_BASE_ALLREDUCE_INTRA_RECURSIVEDOUBLING_DATA_EXCHANGE_TIME,
    OMPI_SPC_BASE_ALLREDUCE_INTRA_RECURSIVEDOUBLING_OPERATION_TIME,
    OMPI_SPC_SENDRECV_POST_IRECV_TIME,
    OMPI_SPC_SENDRECV_SEND_TIME,
    OMPI_SPC_SENDRECV_REQUEST_WAIT_TIME,
    OMPI_SPC_REQUEST_DEFAULT_WAIT,
    OMPI_SPC_REQUEST_DEFAULT_WAIT_ANY,
    OMPI_SPC_REQUEST_DEFAULT_WAIT_ALL,
    OMPI_SPC_REQUEST_DEFAULT_WAIT_SOME,
    OMPI_SPC_OPAL_PROGRESS,
    OMPI_SPC_REQUEST_WAIT_COMPLETION_THREADS,
    OMPI_SPC_OPAL_PROGRESS_TIME,
    OMPI_SPC_REQUEST_DEFAULT_WAIT_REQUEST_WAIT_COMPLETION_TIME,
    OMPI_SPC_REQUEST_DEFAULT_WAIT_CRCP_REQUEST_COMPLETE,
    OMPI_SPC_REQUEST_DEFAULT_WAIT_AFTERMATH,
    OMPI_SPC_IALLREDUCE,
